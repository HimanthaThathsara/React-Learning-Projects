...
// Podcasts List Component to display all podcast episodes
export default async function PodcastsList() {
  ...
  return (
    <div className="flex flex-col max-w-[95rem] w-full mx-auto py-12 md:py-48">
      {/* Map through the podcast data and display each episode */}
        ...
        <div key={podcasts.id}>
          <div className="grid grid-cols-1 md:grid-cols-[auto_auto] justify-between md:items-center gap-3 md:gap-0">
            <div className="flex flex-col md:flex-row md:items-center gap-3 md:gap-16">
              ...
              <Image className="w-[15rem] h-[15rem]" src={podcasts.img} alt={podcasts.imgAlt} width={240} height={240} />
            ...
            <div className="flex flex-col md:flex-row md:items-center flex-wrap gap-2">
              ...
              <Link className="flex gap-2" href={`podcasts/${podcasts.slug}`}>
                <span className="uppercase font-semibold">{ComponentsDetailsFile.PoadcastList.Listen}</span>
                <img src={ComponentsDetailsFile.PoadcastList.Icon} alt={ComponentsDetailsFile.PoadcastList.Icon_alt} />
              </Link>
            </div>
          </div>
