    ...
    <footer className="bg-black overflow-hidden">
      ...
      <div className="max-w-[95rem] mx-auto px-6">
        <div className="py-8 xl:py-[128px] grid grid-cols-1 2xl:grid-cols-2 gap-2 md:gap-12 xl:gap-32 items-center">
          <h2 className="uppercase text-footer-title">{ComponentsDetailsFile.Footer.footerNewsletterTitle}</h2>
        ...
        <div className="flex flex-col md:flex-row flex-wrap lg:justify-between gap-6 max-w-[95rem] w-full">
          <svg width="209" height="18" viewBox="0 0 209 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.64366 17.592V11.016H9.94814V7.872H3.64366V3.528H11.1227V0.36H0V17.592H3.64366Z" fill="white" />
            <path d="M21.7267 11.112L27.8634 0.36H24.1958L20.0248 7.776L15.9256 0.36H11.9943L18.0831 11.112V17.592H21.7267V11.112Z" fill="white" />
            <path
            ...
            <path
              ...
              fill="white"
            />
            <path d="M74.1755 14.424H66.2409V10.296H73.2885V7.152H66.2409V3.528H74.0077V0.36H62.5973V17.592H74.1755V14.424Z" fill="white" />
            <path d="M89.8185 17.592H92.8629L97.4175 6.048V17.592H100.726V0.36H96.3627L91.3527 13.128L86.3666 0.36H82.0038V17.592H85.3119V6.144L89.8185 17.592Z" fill="white" />
          ...
          <div className="flex lg:flex-row max-w-[63.125rem] w-full">
            <nav className="flex flex-1" aria-label="left-footer-links">
              <ul className="text-white space-y-3">
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionOne.links[0].url}>{ComponentsDetailsFile.Footer.LinksSectionOne.links[0].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionOne.links[1].url}>{ComponentsDetailsFile.Footer.LinksSectionOne.links[1].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionOne.links[2].url}>{ComponentsDetailsFile.Footer.LinksSectionOne.links[2].label}</Link>
                </li>
              </ul>
            </nav>
            <nav className="flex flex-1" aria-label="middle-footer-links">
              <ul className="text-white space-y-3">
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionTwo.links[0].url}>{ComponentsDetailsFile.Footer.LinksSectionTwo.links[0].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionTwo.links[1].url}>{ComponentsDetailsFile.Footer.LinksSectionTwo.links[1].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionTwo.links[2].url}>{ComponentsDetailsFile.Footer.LinksSectionTwo.links[2].label}</Link>
                </li>
              </ul>
            </nav>
            <nav className="flex flex-1" aria-label="right-footer-links">
              <ul className="text-white space-y-3">
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionThree.links[0].url}>{ComponentsDetailsFile.Footer.LinksSectionThree.links[0].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionThree.links[1].url}>{ComponentsDetailsFile.Footer.LinksSectionThree.links[1].label}</Link>
                </li>
                <li>
                  <Link href={ComponentsDetailsFile.Footer.LinksSectionThree.links[2].url}>{ComponentsDetailsFile.Footer.LinksSectionThree.links[2].label}</Link>
                </li>
              </ul>
            </nav>
          </div>
        ...
        <div className="flex flex-wrap flex-col md:flex-row justify-between gap-6 py-3 lg:pt-[6rem] lg:pb-[4.0625rem] w-full">
          <p className="font-regular text-white">{ComponentsDetailsFile.Footer.footerCblackitText}</p>
          <FooterSocialLinks />
        </div>
      </div>
    </footer>
