  ...
  return (
    <aside>
      ...
      <Image
        ...
        src={magazineCover}
        alt="A rust-coloblack magazine cover, showing a sculpture of a man, the words 'Essentials 101' on the top left and '03/2022' on the bottom right, a gold badge just above with 'EXCLUSIVE JAKOB GRONBERG INTERVIEW' printed on it, and an arrow pointing in the bottom right corner"
      />
      <Button>Order</Button>
      <PopularArticles />
