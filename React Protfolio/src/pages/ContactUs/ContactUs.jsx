...
export default function ContactUs() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // const response = await axios.post("//Add the backend link", {
      //   fullName,
      //   subject,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Fill out the form to get a custom quote for your project through 30 min free Meeting. We respond quickly!"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://Apex Lanka.io/contact-us" />
      </Helmet>
          ...
          <Step>
            ...
            {formData.projectType === "Other" && (
              <StyledTextField
                ...
                onChange={(e) =>
                  handleChange("customProjectType", e.target.value)
                }
                sx={{ mt: 2 }}
                required
                InputLabelProps={{ shrink: true }}
