...
const defaultSections = [
  {
    ...
    links: [
      ...
      { name: "Popular", href: "/blog/popular" },
...
const Footer = ({
  ...
  description = "Discover stories, insights, and ideas that inspire.",
  socialLinks = defaultSocialLinks,
  copyright = "© 2025 BlogHub All rights reserved.",
        ...
        <div className="flex px-6 lg:px-16  mx-auto w-full flex-col justify-between gap-10 lg:flex-row lg:items-start lg:text-left">
          <div className="flex w-full flex-col justify-between gap-6 lg:items-start">
            ...
            <div className="flex items-center gap-2 lg:justify-start">
              ...
              <h2 className="text-xl font-semibold">BlogHub</h2>
            </div>
