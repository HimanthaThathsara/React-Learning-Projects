  ...
  return (
    <div
      ...
      className={cn(
        ...
        isCenter ? "bg-primary text-primary-foreground border-primary z-10" : "bg-card text-card-foreground border-border hover:border-primary/50 z-0"
      )}
      style={{
        width: cardSize,
        height: cardSize,
      ...
      />
      <h3 className={cn("text-base font-medium sm:text-xl", isCenter ? "text-primary-foreground" : "text-foreground")}>&quot;{testimonial.testimonial}&quot;</h3>
      <p className={cn("absolute right-8 bottom-8 left-8 mt-2 text-sm italic", isCenter ? "text-primary-foreground/80" : "text-muted-foreground")}>- {testimonial.by}</p>
    </div>
  );
};
...
export const Testimonials: React.FC = () => {
  ...
  return (
    <SectionHeading text="Testimonials" id="testimonials" className="h-[600px] overflow-hidden">
