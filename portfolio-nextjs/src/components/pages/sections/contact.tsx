...
export default function Contact() {
  ...
  return (
    <SectionHeading id="contact" text="Contact" className="px-4 py-12 md:px-8 md:py-16">
        ...
        <div className="">
          <form onSubmit={onSubmit} className="w-full">
            <Terminal className="max-h-none w-full max-w-none">
              ...
              {step >= 1 && (
                <>
                  ...
                  <div className="text-foreground/90 flex items-start gap-2 font-mono">
                    ...
                    <TypingAnimation duration={26}>Great! And may i know your name?</TypingAnimation>
                  </div>
              ...
              {step >= 2 && (
                <>
                  <div className="text-foreground/90 flex items-start gap-2 font-mono">
                    ...
                    <TypingAnimation duration={26}>Awesome, now tell us how we can assist you today.</TypingAnimation>
                  </div>
                  ...
                  <AnimatedSpan className="mt-2">
                    <div className="border-foreground/20 border-t border-dashed pt-4">
                      <div className="flex items-center justify-end gap-2">
                        <Button type="button" variant="outline" onClick={onReset} className="border-foreground/20 bg-foreground/5 hover:bg-foreground/10 font-mono text-xs">
              ...
              {status === "sent" && <AnimatedSpan className="font-mono text-emerald-400/90">✓ Message redirected.</AnimatedSpan>}
              {status === "error" && <AnimatedSpan className="font-mono text-red-400/90">⚠ Something went wrong. Please try again.</AnimatedSpan>}
            </Terminal>
          </form>
        </div>
      </div>
