  ...
  const projects = [
    {
      ...
      github: "https://github.com/HimanthaThathsara/My-Portfolio",
      image: "/projects/Protfolio.png",
      live: "https://himanthathathsara.github.io/My-Portfolio/Portfolio.html",
      date: "Sep, 2025",
      status: "completed",
    },
    {
      title: "IOT Dashboard",
      description: "A IOT Dashboard group management.",
      tags: ["Management", "Fullstack"],
      github: "https://github.com/HimanthaThathsara/ShadcnUi-Dashboard-Demo",
      image: "/projects/Admin.png",
      live: "https://shadcnui-dashboard-demo.netlify.app/",
      date: "Oct, 2025",
      status: "completed",
    },
    {
      title: "Apex",
      description: "A feature-rich Web Agency platform, offering fast, curated collections, and a smooth viewing experience.",
      tags: ["Web Agency", "Platform"],
      github: "https://github.com/HimanthaThathsara/Apex-Lanka",
      image: "/projects/Apex.png",
      live: "https://himanthathathsara.github.io/Apex-Lanka/index.html",
      date: "Dec, 2025",
      status: "completed",
    },
  ];
  ...
  return (
    <SectionHeading id="projects" text="Projects">
            ...
            <div className="grid lg:grid-cols-2">
              ...
              <div className="relative flex flex-col justify-center overflow-hidden p-8 md:p-12 lg:p-16">
                ...
                <div className="mb-6 flex flex-wrap items-center gap-3">
                  <time className="text-muted-foreground font-mono text-xs">{project.date}</time>
                  <div className="bg-border h-4 w-px" />
                  <div className="inline-flex items-center gap-1.5">
                    <div className={cn("h-2 w-2 rounded-full", project.status === "completed" ? "animate-pulse bg-green-500" : "animate-pulse bg-yellow-500")} />
                    <span className="text-muted-foreground font-mono text-xs uppercase">{project.status}</span>
                  </div>
                </div>

                {/* Title  */}
                <div className="mb-6">
                  <h3 className="font-incognito text-3xl font-bold lg:text-4xl">{project.title}</h3>
                  <HeadingLine className="mt-3" />
                </div>

                {/* Description */}
                <p className="text-muted-foreground mb-6 text-sm leading-relaxed md:text-base">{project.description}</p>

                {/* Tags  */}
                <div className="mb-8 flex flex-wrap gap-2">
                  {project.tags.map((tag) => (
                    <Badge key={tag} variant="outline" className={cn("border font-mono text-xs")}>
                      {tag}
                    </Badge>
                  ))}
                </div>
                ...
                <div className="flex flex-wrap gap-3">
                  <Button asChild variant="default" size="lg" className="group/btn relative border-2 font-medium" disabled={!project.github}>
                  ...
                  <Button asChild variant="outline" size="lg" className="group/btn border-2 font-medium" disabled={!project.live}>
                    <a href={project.live || undefined} target="_blank" rel="noopener noreferrer">
      ...
      <div className="border-t">
        <motion.div initial={{opacity: 0, y: 20}} whileInView={{opacity: 1, y: 0}} transition={{duration: 0.6}} viewport={{once: true}} className="py-12 text-center">
          <Button asChild variant="ghost" size="lg" className="group font-mono">
            <a href="https://github.com/HimanthaThathsara?tab=repositories" target="_blank" rel="noopener noreferrer">
