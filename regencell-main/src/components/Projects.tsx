...
const projects = [
  {
    ...
    brand: "FireCat Group",
    description:
      "AI-driven sensor solution integrated into uniforms for law enforcement, military and firefighters, providing real-time vital monitoring and situational awareness in high-risk environments.",
    tags: ["Safety", "Military", "AI Sensors", "Real-time Monitoring"],
    imageUrl: "/Images/93ab0638-8190-4ccf-897f-21fda7f4f5ad.png",
    isFeatured: true,
    link: "/projects/firecat",
    details: `
      FireCat Group aimed to enhance safety in high-risk environments. RegenCell Technologies provided the 6th SENSE solution with secure real-time data transmission, high-quality sensors resistant to extreme conditions, integrated AI-powered clothing, and a centralized control unit. Features include Man Down Alarm, GPS positioning, vital sign monitoring, and Panic Button. Benefits: life-saving technology, machine learning preventing false alarms, durable hardware with 7-10 year lifespan, washable sensors, and Plug & Play installation with 12-20 hours of operation per charge.
    `,
  },
  {
    id: 2,
    title: "Performance Athletic Footwear",
    brand: "Global  Retail Leader",
    description: "Smart Footwear R&D aiming to revolutionize development, fitting, and testing of athletic footwear.",
    tags: ["", "R&D", "Footwear", "Athletic Performance"],
  ...
  },
  {
    ...
    brand: "European Multinational  Producer",
  ...
  },
  {
    ...
    tags: ["Ice Hockey", "Motion Analysis", "Performance Tracking", ""],
    imageUrl: "/Images/c30e0487-2fa0-41d1-9a0b-699cb2855388.png",
  ...
  },
  {
    ...
    imageUrl: "/Images/d5ce901e-2ce0-4f2a-bce1-f0ca5d6192df.png",
    ...
    <section id="projects" ref={projectsRef} className="bg-white py-[50px] w-full">
      <div className="w-full px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className={`text-center mb-10 max-w-3xl mx-auto transition-all duration-1000 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="inline-block mb-2 px-3 py-1 bg-gray-100 text-gray-600 rounded-full text-sm font-medium">Customer Cases</div>
          <h2 className="text-3xl font-bold mb-3">From to Intelligence</h2>
          <p className="text-gray-600">Explore how our sensor technology is revolutionizing multiple industries with intelligent fabric solutions tailored to specific needs.</p>
          {isMobile && (
        ...
        <div
          ...
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
            {projects.map((project, index) => (
              <div key={project.id} className={`absolute top-0 w-full max-w-md transform transition-all duration-500 ${getCardAnimationClass(index)}`} style={{transitionDelay: `${index * 50}ms`}}>
                <Card className="overflow-hidden h-[500px] border border-gray-100 shadow-sm hover:shadow-md flex flex-col">
                  ...
                  <CardContent className="p-6 flex flex-col flex-grow">
                    <div className="mb-4">
                      <h3 className="text-xl font-bold mb-1 text-gray-800 group-hover:text-gray-500 transition-colors">{project.title}</h3>
                    ...
                    <div className="mt-auto">
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.tags.map((tag, idx) => (
                          <span key={idx} className="px-2 py-1 bg-gray-50 text-gray-600 rounded-full text-xs animate-pulse-slow" style={{animationDelay: `${idx * 300}ms`}}>
                            {tag}
                          </span>
                        ))}
                      </div>
