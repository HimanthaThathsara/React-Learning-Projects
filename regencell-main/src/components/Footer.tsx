      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 pb-10 border-b border-gray-700">
          <div className="lg:col-span-2">
            <img
              src="/Images/7d120ee6-3614-4b75-9c35-716d54490d67.png"
              alt="RegenCell Technologies Logo"
              className="h-10 w-auto mb-6 invert" // Added invert to make logo white
            />
            <p className="text-gray-300 mb-6">
              RegenCell Technologies provides an end-to-end platform for the creation and deployment of AI-powered smart sensor devices, giving customers 100% ownership while handling the complete
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.linkedin.com/company/RegenCelltechnologies/"
                target="_blank"
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">© {new Date().getFullYear()} RegenCell Technologies. All rights reserved.</p>
