      ...
      <div className="banner-container bg-black relative overflow-hidden h-[50vh] sm:h-[60vh] md:h-[500px] lg:h-[550px] xl:h-[600px] w-full">
        <div className="absolute inset-0 bg-black w-full">
          <video
            ...
            poster="/Images/4bfa0d71-3ed2-4693-90b6-35142468907f.png">
            <source src="/Images/video_1751292840840_1751292842546.mp4" type="video/mp4" />
            {/* Fallback image if video fails to load */}
            <img
              src="/Images/4bfa0d71-3ed2-4693-90b6-35142468907f.png"
              alt="RegenCell Technologies Connected People"
              className={`w-full h-full object-cover opacity-70 grayscale ${isMobile ? "object-right" : "object-center"}`}
            />
          </video>
          ...
          <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
            <motion.div className="w-full max-w-4xl text-center" variants={itemVariants}>
              <motion.h1 className="banner-title text-white" variants={itemVariants}>
                The Future of Cell Tower Monitoring is here.
              </motion.h1>
              <motion.p className="banner-subtitle text-gray-300 mt-4 sm:mt-6" variants={itemVariants}>
                We integrate AI-powered sensors into clothing, footwear, and s.
              </motion.p>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 mx-auto">
        <motion.div
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <h3 className="text-base md:text-lg font-semibold mb-1 md:mb-2 text-gray-800">Smart s</h3>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <p className="text-gray-600 text-xs md:text-sm">Industry-specific algorithms that transform sensor data into meaningful insights.</p>
          </motion.div>
          ...
          <motion.div className="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-100 transform transition-all duration-300 hover:-translate-y-1 hover:shadow-md" variants={itemVariants}>
            ...
            <p className="text-gray-600 text-xs md:text-sm">Solutions for , military, healthcare, industrial, and professional environments.</p>
          </motion.div>
        </motion.div>
      </div>
    </motion.div>
