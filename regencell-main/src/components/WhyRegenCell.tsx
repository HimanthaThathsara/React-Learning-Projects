...
const WhyRegenCell = () => {
  ...
  return (
    <section id="why-RegenCell" className="relative py-16 md:py-24 bg-white overflow-hidden">
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          <motion.p variants={itemVariants} className="text-gray-600 text-lg max-w-3xl mx-auto">
            In an industry where complexity leads to failure, we bring simplicity and expertise to ensure Reliability.
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">Market estimated to reach this value by 2040, with massive growth potential for Telecommunication solutions</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">of IoT projects stall at the proof-of-concept stage due to fragmented expertise and poor coordination</p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="bg-gray-100 p-6 rounded-xl border border-gray-200 text-center hover:bg-gray-200 transition-all">
            ...
            <p className="text-gray-700">Increase in time-to-market for IoT products over the past four years, creating costly delays</p>
          </motion.div>
        </motion.div>
        ...
        <motion.div
          ...
          <motion.div variants={itemVariants} className="text-center mb-8">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">What RegenCell Does for You</h3>
            <p className="text-gray-600 max-w-2xl mx-auto">We transform your ideas into market-ready solutions with tangible benefits for your business</p>
          </motion.div>
