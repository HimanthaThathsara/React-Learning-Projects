...
const EMAILJS_TEMPLATE_ID = ""; // Updated to the correct template ID
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const templateParams = {
        ...
        to_name: "RegenCell Team", // Adding recipient name parameter
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-700 text-black">
              ...
              <a href="mailto:info@RegenCell.com" className="text-blue-500 hover:underline">
                hello@RegenCell.com
              </a>
