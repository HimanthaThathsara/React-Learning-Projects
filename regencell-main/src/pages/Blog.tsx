...
const Blog = () => {
  ...
  return (
    <PageLayout>
      <SEO
        title="RegenCell - News and insights about Cell Tower Monitoring"
        description="Stay updated with the latest news and insights about sensor-integrated s and smart technology from RegenCell Technologies."
        imageUrl={featuredPost?.imageUrl || "/Images/6b0637e9-4a7b-40d0-b219-c8b7f879f93e.png"}
        keywords={["smart s", " technology", "industry news", "sensor innovation", " tech", "smart fabrics"]}
        type="website"
      />
      ...
      <div className="w-full pt-24 pb-12 bg-gradient-to-b from-black to-gray-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">RegenCell News &amp; Insights</h1>
            <p className="text-xl text-gray-300 mb-6">The latest trends and news in sensor-integrated s and smart technology</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          {otherPosts.map((post) => (
            <BlogPostCard
              ...
              imageUrl={post.imageUrl || "/Images/48ecf6e2-5a98-4a9d-af6f-ae2265cd4098.png"}
              date={post.date}
              slug={post.slug}
          ...
          {blogPosts.length < 4 &&
            Array.from({length: Math.max(0, 4 - blogPosts.length)}).map((_, index) => (
              <BlogPostCard
                ...
                excerpt="Stay tuned for more exciting articles about smart s and sensor technology."
                imageUrl={index % 2 === 0 ? "/Images/6b0637e9-4a7b-40d0-b219-c8b7f879f93e.png" : "/Images/700e27d7-0513-4bfa-8ac4-f7fd6087594c.png"}
                date="Coming soon"
                slug="#"
                category="Upcoming"
              />
