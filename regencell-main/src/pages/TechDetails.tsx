          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <motion.p
                ...
                Explore the technical details behind our smart sensor technology and learn how our system architecture enables rapid development and deployment.
              </motion.p>
              ...
              <motion.div
                ...
                <p className="text-gray-600 mb-8 text-base max-w-3xl">
                  Our platform uses a three-tier architecture connecting physical devices to our cloud services and user applications. The diagram below illustrates how data flows through our system,
                  from sensor collection to user-facing applications.
                </p>
              ...
              <motion.div
                ...
                <p className="text-gray-600 mb-8 text-base max-w-3xl">
                  At RegenCell, we've developed a systematic approach to creating smart solutions that combines technical innovation with practical implementation. Our comprehensive development
                  process ensures that every project moves efficiently from concept to market-ready product.
                </p>
