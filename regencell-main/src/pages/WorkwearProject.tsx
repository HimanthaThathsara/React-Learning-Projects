...
const WorkwearProject = () => {
  return (
    <ProjectPageLayout
      ...
      brandName="European Multinational  Producer">
      ...
      <div className="bg-gray-50 p-6 rounded-lg mb-8">
        ...
        <p>
          A leading European manufacturer sought to create next-generation workwear for professionals operating in extreme temperature environments. From arctic construction workers to foundry
          operators, they needed a solution that could actively regulate body temperature without compromising mobility or safety compliance.
        </p>
      </div>

      <h3 className="text-2xl font-semibold mb-4">Challenge</h3>
      <p>
        Traditional approaches to temperature regulation in workwear were either passive (insulation) or bulky active systems with external power sources and limited zoning capabilities. The client
        needed a fully integrated solution that could adapt to changing conditions, worker activity levels, and provide targeted temperature control while maintaining all safety certifications.
      </p>

      <h3 className="text-2xl font-semibold mb-4 mt-8">Solution</h3>
      <p>RegenCell Technologies developed a comprehensive climate control workwear platform featuring:</p>
      ...
      <div className="grid md:grid-cols-2 gap-6 my-8">
        <div className="bg-white shadow-md rounded-lg p-6 border border-gray-100 flex items-start">
          ...
          <div>
            ...
            <p>-integrated heating and cooling elements with multi-zone temperature control.</p>
          </div>
        </div>
      ...
      <p>
        The prototype climate-controlled workwear has shown promising results in controlled testing environments. The technology is being evaluated by select industrial clients across Northern Europe
        and Canada, focusing on oil & gas, mining, and construction sectors operating in extreme climates. Initial feedback indicates significant potential for reducing cold-related work disruptions.
      </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg mt-8 flex items-start">
        ...
        <div>
          ...
          <p>
            Current R&D efforts are focused on refining the prototypes, improving power efficiency, and exploring the potential to include environmental hazard detection capabilities and integration
            with wider workplace safety systems.
          </p>
        </div>
      </div>
    </ProjectPageLayout>
