...
const FloatingAvatar = () => {
  ...
  const [isDismissed, setIsDismissed] = useLocalStorage("floating_avatar_dismissed", false);
        ...
        <motion.div className="fixed bottom-36 -left-40 z-50 sm:-left-46 md:-left-58">
          <div className="relative flex items-end gap-4">
            ...
            <motion.div
              ...
              <SpeechBubble direction="left" borderColor={"#000000"} bg={"#fff"} textColor={"#000000"} className="max-w-[280px] min-w-[240px]">
                <p className="mb-4 text-sm leading-relaxed font-bold">Psst... Would you like to chat personally?</p>

                <div className="flex gap-2">
                  <a href="#" target="_blank" rel="noopener,noreferrer" className="group flex h-8 flex-1 items-center justify-center gap-2 bg-[#0088cc] font-bold text-white">
