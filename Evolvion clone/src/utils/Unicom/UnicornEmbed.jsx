...
const UnicornEmbed = ({ projectId }) => {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            const script = document.querySelector(`script[src="https://cdn.unicorn.studio/v1.4.1/unicornStudio.umd.js"]`);
            if (script) script.remove();
        };
    }, []);

    useEffect(() => {
        if (isInitialized && window.UnicornStudio && typeof window.UnicornStudio.embed === 'function') {
...
{/* <UnicornEmbed projectId='xC6nc0RjHHQ1R1CPcPpA' /> */ }
{/* <UnicornEmbed projectId='ldNwV5JS2jsClat2liZY' /> */ }